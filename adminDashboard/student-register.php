...
<div class="menu">
  ...
  <div class="items"><a class="active" href="./student-register.php">StudentRegister</a></div><hr/>
...
<!--table-->
<div class="row" style="margin-left:320px;margin-top:10px;margin-right:10px">
      ...
      <table id="studentTable" class="table text-center mt-5 pt-3 table-bordered">
         <thead style="background-color:gray;color:white">
            ...
            $sql="SELECT id, name, email, password from student_register";
