...
if (isset($_GET['updateid'])) {
    $id = $_GET['updateid'];
    // Validate $id to ensure it's a non-empty integer
    if (!empty($id) && is_numeric($id)) {
        ...
        // Invalid 'updateid' parameter
        echo "Invalid 'updateid' parameter.";
        exit; // Stop execution
    }
} else {
    // 'updateid' parameter not set in the URL
    echo "Please provide the 'updateid' parameter in the URL.";
    exit; // Stop execution
}
...
if (isset($_POST['submit'])) {
    ...
    $sql = "UPDATE company SET name='$name', number='$number', email='$email', location='$location', position='$position', requirement='$requirement', jobtype='$jobtype',
     jobdetails='$jobdetails',expiration_time='$expirationTime' WHERE id=$id";
    $result = mysqli_query($con, $sql);
    if ($result) {
...
<script>
  ...
  const dropdowns = document.querySelectorAll('.sub-btn');
    ...
    <div id="add-company" class="wrapper" style="background-color: white; height: 550px;">
        <div class="form-box">
            ...
            <form method="post">
                ...
                <?php if(strpos($requirement, 'BBA') != false) echo 'checked'; ?>
                <h4>Requirement</h4><br>
<div class=" course-list" style="display:flex;flex-direction:row;">
  
  <div class="left">
  <input class="course"  type="checkbox" id="BBA-CA-1" name="requirement[]" value="BBA-CA-1"  <?php if(strpos($requirement, 'BBA-CA-1') !== false) echo 'checked'; ?>>
  <label for="BBA-CA-1"> BBA-CA-1</label><br>
  <input class="course"  type="checkbox" id="BBA-CA-2" name="requirement[]" value="BBA-CA-2"  <?php if(strpos($requirement, 'BBA-CA-2') !== false) echo 'checked'; ?>>
  <label for="BBA-CA-2"> BBA-CA-2</label><br>
  <input class="course"  type="checkbox" id="BBA-CA-3" name="requirement[]" value="BBA-CA-3"  <?php if(strpos($requirement, 'BBA-CA-3') !== false) echo 'checked'; ?>>
  <label for="BBA-CA-3"> BBA-CA-3</label><br>
  <input class="course" type="checkbox" id="BBA-1" name="requirement[]" value="BBA-1"  <?php if(strpos($requirement, 'BBA-1') !== false) echo 'checked'; ?>>
  <label for="BBA-1"> BBA-1</label><br>
  <input class="course" type="checkbox" id="BBA-2" name="requirement[]" value="BBA-2"  <?php if(strpos($requirement, 'BBA-2') !== false) echo 'checked'; ?>>
  <label for="BBA-2"> BBA-2</label><br>
  <input class="course" type="checkbox" id="BBA-3" name="requirement[]" value="BBA-3"  <?php if(strpos($requirement, 'BBA-3') !== false) echo 'checked'; ?>>
  <label for="BBA-3"> BBA-3</label><br>
  <input class="course" type="checkbox" id="BA-1" name="requirement[]" value="BA-1"  <?php if(strpos($requirement, 'BA-1') !== false) echo 'checked'; ?>>
  <label for="BA-1"> BA-1</label><br> 
  <input class="course" type="checkbox" id="BA-2" name="requirement[]" value="BA-2" <?php if(strpos($requirement, 'BA-2') !== false) echo 'checked'; ?>>
  <label for="BA-2"> BA-2</label><br>
  <input class="course" type="checkbox" id="BA-3" name="requirement[]" value="BA-3" <?php if(strpos($requirement, 'BA-3') !== false) echo 'checked'; ?>>
  <label for="BA-3"> BA-3</label><br>
  <input class="course" type="checkbox" id="B-COM-1" name="requirement[]" value="B-COM-1" <?php if(strpos($requirement, 'B-COM-1') !== false) echo 'checked'; ?>>
  <label for="B-COM-1"> B-COM-1</label><br>
  <input class="course" type="checkbox" id="B-COM-2" name="requirement[]" value="B-COM-2" <?php if(strpos($requirement, 'B-COM-2') !== false) echo 'checked'; ?>>
  <label for="B-COM-2"> B-COM-2</label><br>
  <input class="course" type="checkbox" id="B-COM-3" name="requirement[]" value="B-COM-3" <?php if(strpos($requirement, 'B-COM-3') !== false) echo 'checked'; ?>>
  <label for="B-COM-3"> B-COM-3</label><br>
  </div>
  <div class="right" style="padding-left:5rem;">
  <input class="course"  type="checkbox" id="BSC-1" name="requirement[]" value="BSC-1" <?php if(strpos($requirement, 'BSC-1') !== false) echo 'checked'; ?>>
  <label for="BSC-1"> BSC-1</label><br>
  <input class="course"  type="checkbox" id="BSC-2" name="requirement[]" value="BSC-2" <?php if(strpos($requirement, 'BSC-2') !== false) echo 'checked'; ?>>
  <label for="BSC-2"> BSC-2</label><br>
  <input class="course"  type="checkbox" id="BSC-3" name="requirement[]" value="BSC-3" <?php if(strpos($requirement, 'BSC-3') !== false) echo 'checked'; ?>>
  <label for="BSC-3"> BSC-3</label><br>
  <input class="course" type="checkbox" id="M-COM-1" name="requirement[]" value="M-COM-1" <?php if(strpos($requirement, 'M-COM-1') !== false) echo 'checked'; ?>>
  <label for="M-COM-1"> M-COM-1</label><br>
  <input class="course" type="checkbox" id="M-COM-2" name="requirement[]" value="M-COM-2" <?php if(strpos($requirement, 'M-COM-2') !== false) echo 'checked'; ?>>
  <label for="M-COM-2"> M-COM-2</label><br>
  <input class="course" type="checkbox" id="MCA-1" name="requirement[]" value="MCA-1" <?php if(strpos($requirement, 'MCA-1') !== false) echo 'checked'; ?>>
  <label for="MCA-1"> MCA-1</label><br>
  <input class="course" type="checkbox" id="MCA-2" name="requirement[]" value="MCA-2" <?php if(strpos($requirement, 'MCA-2') !== false) echo 'checked'; ?>>
  <label for="MCA-2"> MCA-2</label><br>
  <input class="course"  type="checkbox" id="MBA-1" name="requirement[]" value="MBA-1" <?php if(strpos($requirement, 'MBA-1') !== false) echo 'checked'; ?>>
  <label for="MBA-1"> MBA-1</label><br>
  <input class="course"  type="checkbox" id="MBA-2" name="requirement[]" value="MBA-2" <?php if(strpos($requirement, 'MBA-2') !== false) echo 'checked'; ?>>
  <label for="MBA-2"> MBA-2</label><br>
  </div>
</div>
                <div class="input-box">
                    <label>Job Type</label><br>
                    <input type="text" name="jobtype" value="<?php echo $jobtype; ?>" required>
                    <span class="icon"><i class="fa-solid fa-tasks"></i></span>
                </div>
                <div class="input-box">
                    <label>Job Description</label><br>
                    <textarea name="jobdetails" rows="4" cols="50" required><?php echo $jobdetails; ?></textarea>
                </div>
                <div class="input-box">
                    <label>Expiration Time</label><br>
                    <input type="datetime-local" name="expiration_time" value="<?php echo  $expirationTime; ?>" required>
