...
<div class="menu">
  ...
  <div class="items"><a class="sub-btn active" style="cursor:pointer;">BBA(CA) 
            <i class="fa-solid fa-angle-right dropdown" ></i></a>
            <div class="sub-menu">
              
                <a href="../BBA(CA)/year-2.php" class="sub-items">year 2</a><hr />
                <a  href="../BBA(CA)/year-3.php" class="sub-items active">year 3</a><hr />
            </div>
        </div><hr />
...
<div class="row" style="margin-left:260px;margin-top:50px;margin-right:10px">
      <h1>BBA(CA) 3rd year Student Details</h1>
      <table class="table text-center mt-5 pt-3 table-bordered" id="studentTable">
       ...
       if(mysqli_connect_error())
        ...
        $query = mysqli_query($con, "SELECT * FROM cv_detail WHERE course = 'BBA-CA-3'");
